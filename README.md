...
gh release create v1.3.4 \
  app/build/outputs/apk/release/app-release.apk#RadixLab-1.3.4.apk \
  --title "进制工坊 v1.3.4" \
  --notes "键盘键位与宽度比例对齐系统输入法布局习惯。功能与上一版保持一致。"
```

发布后，官网的下载按钮即可使用永久链接：

```
https://github.com/xiaoyu240/RadixLab/releases/latest/download/RadixLab-1.3.4.apk
```
